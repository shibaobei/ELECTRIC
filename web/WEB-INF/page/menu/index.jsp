						...
						<td height="99" width="27%">
							<table border="0" width="70%" id="table4">
								...
								<tr>
									...
									<td>
										<%--<input type="text" name="name" style="width: 125 px" size="20" value="<%=name%>"  maxlength="25">--%>
								...
								<tr>
									...
									<td>
										<input type="password" name="password" style="width: 125 px" size="20" value="${requestScope.password}"  maxlength="25">
										<%--<input type="password" name="password" style="width: 125 px" size="20" value="<%=password%>"  maxlength="25">--%>
									</td>
