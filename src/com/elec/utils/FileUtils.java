...
public class FileUtils {
	 ...
	 * @return
	 */
	public static String fileDownloadReturnPath(String fileID){
	...
	public static void main(String[] args) {
		File srcFile = new File("E:\\IntellijIDEA\\dir\\a.txt");
		File destFile = new File("E:\\IntellijIDEA\\dir\\dir2ddddd\\a.txt");
		//复制
		try {
